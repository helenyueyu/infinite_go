...
ActiveRecord::Schema.define(version: 2020_06_29_152532) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "bookmarkable_id"], name: "index_bookmarks_on_user_id_and_bookmarkable_id", unique: true
  end
  ...
  create_table "ignored_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "tag_id"], name: "index_ignored_tags_on_user_id_and_tag_id", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "description", default: "Apparently, this user prefers to keep an air of mystery about them.", null: false
  ...
  create_table "watched_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "tag_id"], name: "index_watched_tags_on_user_id_and_tag_id", unique: true
  end
